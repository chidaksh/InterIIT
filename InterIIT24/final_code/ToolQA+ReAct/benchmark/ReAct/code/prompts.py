...
You may take as many steps as necessary. Do not output anything other than the answer in proper JSON format. Do not use any other tools than the tools mentioned above.
Here are some examples:
{examples}
(END OF EXAMPLES)
Question: {question}{scratchpad}
